        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="title" class="form-control" placeholder="{{ __('Job Title') }}" value="{{ old('name') }}" maxlength="255" required/>
                    </div>
                </div>   
                <!-- description -->
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea name="description" rows="10" class="form-control" placeholder="{{ __('Job Description') }}" maxlength="255" required></textarea>
                    </div>
                </div>  
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-success float-right" type="submit">@lang('Create Job')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
